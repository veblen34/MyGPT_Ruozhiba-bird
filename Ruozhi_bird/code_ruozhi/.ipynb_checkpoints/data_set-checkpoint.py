...
def train_model(fname, prefix):
    spm.SentencePieceTrainer.train(
        input=fname, model_prefix=prefix, vocab_size=25000,)  # 16000->25000
...
if __name__ == '__main__':
    train_model("Ruozhibird.txt", "Ruozhibird")
    gen_dataset("Ruozhibird.txt", "Ruozhibird.model")
    # test_samples()